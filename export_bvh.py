...
filenames = [f[:-4] for f in os.listdir('C:/Dev/zeroeggs-retarget/fbx') if f.endswith('.fbx')]

for file in filenames:
    
    input_file = 'C:/Dev/zeroeggs-retarget/fbx/'+file+'.fbx'
    output_file = 'C:/Dev/zeroeggs-retarget/bvh/'+file+'.bvh'
